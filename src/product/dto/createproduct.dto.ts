...
export class CreateProductDTO {
    ...
    constructor(product_name: string, product_description: string, price: number, count: number, categoryId: number) {
        if (isNotEmpty(product_name) && isNotEmpty(product_description) && isNotEmpty(price))
        {
